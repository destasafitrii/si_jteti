                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group mb-4">
                                                <label class="mb-2" for="input-date1">Nama</label>
                                                <input id="input-date1" class="form-control">
                                            </div>
                                            <div class="form-group mb-4">
                                                <label class="mb-2" for="input-date1">NIDN</label>
                                                <input id="input-date1" class="form-control">
                                            </div>
                                            <div class="form-group mb-4">
                                                <label class="mb-2" for="input-date1">NIP</label>
                                                <input id="input-date1" class="form-control">
                                            </div>
                                            <div class="form-group mb-4">
                                                <label class="mb-2" for="input-date1">Jabatan</label>
                                                <input id="input-date1" class="form-control">
                                            </div>
                                            <div class="form-group mb-4">
                                                <label class="mb-2" for="input-date1">Foto</label>
                                                <input type="file" id="input-date1" class="form-control">
                                            </div>
