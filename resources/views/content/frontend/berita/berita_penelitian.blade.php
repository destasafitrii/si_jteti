            ...
            <div class="col-xl-4 col-lg-6 mb-30">
                <div class="blog__two-item page">
                    <div class="blog__two-item-image">
                        <a href="detail_berita"><img src="{{ Storage::url('fotos/' . $beritapenelitian->foto) }}"  style="width: 450px; height: 250px; object-fit: cover; alt=""></a>
                    </div>
                    <div class="blog__two-item-content">
                        <div class="blog__two-item-content-meta">
                        </div>
                        <h4><a href="detail_berita">{{ $beritapenelitian->judul }}</a></h4>
