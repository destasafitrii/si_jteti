            ...
            <div class="col-xl-4 col-lg-6 mb-30">
                <div class="blog__two-item page">
                    ...
                    <div class="blog__two-item-content">
                        ...
                        <a class="btn-six" href="{{ route('berita_penelitian.show', $beritapenelitian->id) }}">Selengkapnya<i class="far fa-chevron-double-right"></i></a>
                    </div>
                </div>
            </div>
            @endforeach
