            ...
            <div class="col-xl-12">
                <div class="project__details-area">
                    <div class="project__details-area-image dark__image">
                        <img src="{{ Storage::url('fotos/' . $ruangmanajemen->foto) }}" alt="" style ="width: 1290px; height: 600px; object-fit: cover;">
                    </div>
                    </div>
                    <h3 class="mb-30" style="padding-top: 20px;">{{ $ruangmanajemen->nama }}</h3>
                    <p class="mb-35">{{ $ruangmanajemen->deskripsi }}</p>
